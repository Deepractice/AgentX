...
import type { Sandbox } from "~/ecosystem/runtime/container/sandbox";
import type { RuntimeDriver } from "~/ecosystem/runtime/container/driver/RuntimeDriver";
 ...
 */
export interface Runtime extends Ecosystem<EnvironmentEvent> {
